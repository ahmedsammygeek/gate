...
<div class="row">
	<div class="col-md-12">
		<div class="card">
			...
			<form class="" method="POST" action="{{ route('board.trainers.store') }}" enctype="multipart/form-data">
				<div class="card-body">
					@csrf
					<div class="mb-4">
						...
						<div class="row mb-3">
							...
							<div class="col-lg-10">
								<input type="text" name="name" value="{{ old('name') }}" class="form-control @error('name')  is-invalid @enderror" required placeholder="اسم المدرب">
								@error('name')
								<p class='text-danger' > {{ $message }} </p>
								@enderror
							</div>
						...
						<div class="row mb-3">
							...
							<div class="col-lg-10">
								<input type="text" name="job_title" value='{{ old('job_title') }}' class="form-control @error('job_title')  is-invalid @enderror" required placeholder='المسمى الوظيفى' >
							</div>
							@error('job_title')
							<p class='text-danger' > {{ $message }} </p>
							@enderror
					...
					<div class="row mb-3">
						...
						<div class="col-lg-10">
							<input type="text" name="youtube" value='{{ old('youtube') }}' class="form-control @error('youtube')  is-invalid @enderror" required placeholder='' >
