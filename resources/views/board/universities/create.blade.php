					...
					<div class="mb-4">
						...
						<div class="row mb-3">
							<div class="col-md-6">
								...
								<div class="col-lg-12">
									<input type="text" name="title_ar" value="{{ old('title_ar') }}" class="form-control @error('title_ar')  is-invalid @enderror"  placeholder="اسم الجامعه بالعربيه">
									@error('title_ar')
									<p class='text-danger' > {{ $message }} </p>
									@enderror
								</div>
							...
							<div class="col-md-6">
								...
								<div class="col-lg-12">
									<input type="text" name="title_en" value="{{ old('title_en') }}" class="form-control @error('title_en')  is-invalid @enderror"  placeholder="اسم الجامعه بالانجليزيه">
									@error('title_en')
									<p class='text-danger' > {{ $message }} </p>
									@enderror
								</div>
						...
						<div class="row mb-3">
							...
							<div class="col-md-4">
								...
								<div class="col-lg-12">
									<input type="number" name="rate" value="{{ old('rate') }}" class="form-control @error('rate')  is-invalid @enderror"  placeholder="التقييم">
									@error('rate')
									<p class='text-danger' > {{ $message }} </p>
									@enderror
								</div>
