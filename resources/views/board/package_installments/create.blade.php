...
<a href="{{ route('board.packages.installments.index' , $package ) }}" class="breadcrumb-item"> اقساط الباقه </a>
...
<div class="row">
	...
	<div class="col-md-12">
		<div class="card">
			...
			<form  method="POST" action="{{ route('board.packages.installments.store' , $package ) }}" enctype="multipart/form-data" >
				<div class="card-body">
					@csrf
					<div class="mb-4">
