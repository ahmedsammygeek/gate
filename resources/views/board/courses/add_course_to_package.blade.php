...
<div class="row">
		...
		<a href='{{ route('board.courses.courses.index' , $course ) }}' class="btn btn-primary mb-2" style="float: left;margin-left:  20px;">
	...
	<div class="col-md-12">
		<div class="card">
			...
			<form  method="POST" action="{{ route('board.courses.courses.store' , $course ) }}" enctype="multipart/form-data" >
				<div class="card-body">
					@csrf
					<div class="mb-4">
					<div class="fw-bold border-bottom pb-2 mb-3"> بيانات الكورس </div>
						<div class="row mb-3">
							...
							<div class="col-lg-10">
								<select name="courses[]" class='form-control form-select'  multiple="" id="">
				...
				<div class="card-footer d-flex  justify-content-end">
					<a  href='{{ route('board.courses.courses.index' , $course  ) }}' class="btn btn-light" id="reset"> الغاء </a>
