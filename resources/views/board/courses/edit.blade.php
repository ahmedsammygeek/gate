			...
			<form class="" method="POST" action="{{ route('board.courses.update' , $course ) }}" enctype="multipart/form-data">
				<div class="card-body">
					...
					<div class="mb-4">
							...
							<div class="col-md-3">
								...
								<div class="col-lg-12">
									<select name="category_id" class='form-control form-select' id="">
										...
										<option value="{{ $category->id }}" {{ $category->id == $course->category_id  ? 'selected="selected"' : '' }} > {{ $category->name }} </option>
										@endforeach
									</select>
									@error('category_id')
									<p class='text-danger' > {{ $message }} </p>
							...
							<div class="col-md-3">
								...
								<div class="col-lg-12">
									<select name="university_id" class='form-control form-select' id="">
										...
										<option value="{{ $university->id }}" {{ $university->id == $course->university_id  ? 'selected="selected"' : '' }} > {{ $university->title }} </option>
										@endforeach
									</select>
									@error('university_id')
									<p class='text-danger' > {{ $message }} </p>
							...
							<div class="col-md-3">
								...
								<div class="col-lg-12">
									<select name="trainer_id" class='form-control form-select' id="">
										...
										<option value="{{ $trainer->id }}"  {{ $trainer->id == $course->trainer_id  ? 'selected="selected"' : '' }}> {{ $trainer->name }} </option>
										@endforeach
									</select>
									@error('trainer_id')
									<p class='text-danger' > {{ $message }} </p>
						...
						<div class="row mb-3">
							<div class="col-md-6">
								...
								<div class="col-lg-12">
									<input type="text" name="title_ar" value="{{ $course->getTranslation('title' , 'ar' ) }}" class="form-control @error('title_ar')  is-invalid @enderror" required placeholder="عنوان الكورس">
									@error('title_ar')
									<p class='text-danger' > {{ $message }} </p>
									@enderror
								</div>
							...
							<div class="col-md-6">
								...
								<div class="col-lg-12">
									<input type="text" name="title_en" value="{{ $course->getTranslation('title' , 'en' ) }}" class="form-control @error('title_en')  is-invalid @enderror" required placeholder="عنوان الكورس">
									@error('title_en')
									<p class='text-danger' > {{ $message }} </p>
									@enderror
								</div>
					...
					<div class="row mb-3">
						...
						<div class="col-lg-12">
							<input type="text" name="subtitle_ar" value='{{ $course->getTranslation('subtitle' , 'ar') }}' class="form-control @error('subtitle_ar')  is-invalid @enderror" required placeholder='نبذه تعريفيه عن الكورس بالعربيه' >
						</div>
						@error('subtitle_ar')
						<p class='text-danger' > {{ $message }} </p>
						@enderror
					...
					<div class="row mb-3">
						...
						<div class="col-lg-12">
							<input type="text" name="subtitle_en" value='{{ $course->getTranslation('subtitle' , 'en') }}' class="form-control @error('subtitle_en')  is-invalid @enderror" required placeholder='نبذه تعريفيه عن الكورس بالانجليزيه' >
						</div>
						@error('subtitle_en')
						<p class='text-danger' > {{ $message }} </p>
						@enderror
					...
					<div class="row mb-3">
						<div class="col-md-3">
							...
							<div class="col-lg-12">
								<input type="number" name="price" value='{{ $course->price }}' class="form-control @error('price')  is-invalid @enderror" required placeholder='' >
								@error('price')
								<p class='text-danger' > {{ $message }} </p>
								@enderror
							</div>
						...
						<div class="col-md-3">
							...
							<div class="col-lg-12">
								<input type="number" name="price_after_discount" value='{{ $course->price_after_discount }}' class="form-control @error('price_after_discount')  is-invalid @enderror"  placeholder='' >
						...
						<div class="col-md-3">
							...
							<div class="col-lg-12">
								<input type="number" name="discount_percentage" value='{{ $course->discount_percentage }}' class="form-control @error('discount_percentage')  is-invalid @enderror"  placeholder='' >
						...
						<div class="col-md-3">
							...
							<div class="col-lg-12">
								<input type="date" name="discount_end_at" value='{{ $course->discount_end_at }}' class="form-control @error('discount_end_at')  is-invalid @enderror"  placeholder='' >
					...
					<div class="row mb-3 ">
						<div class="col-md-3">
							...
							<div class="col-lg-12">
								<input type="number" name="price_later" value='{{ $course->price_later }}' class="form-control @error('price_later')  is-invalid @enderror"  placeholder='' >
								@error('price_later')
								<p class='text-danger' > {{ $message }} </p>
								@enderror
							</div>
						...
						<div class="col-md-6">
							...
							<div class="col-lg-12">
								<label class="form-check form-switch">
									<input type="checkbox" value='1' class="form-check-input" name="show_in_home"   {{ $course->show_in_home == 1 ? 'checked' : '' }} >
