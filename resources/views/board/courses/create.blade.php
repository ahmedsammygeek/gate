                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-3">
                                    <label class="col-form-label col-lg-12"> صوره الكورس
                                ...
                                <div class="col-md-2">
                                    <label class="col-form-label col-lg-12"> التصنيف <span
                                ...
                                <div class="col-md-3">
                                    <label class="col-form-label col-lg-12"> الجامعه <span
                                            class="text-danger">*</span></label>
                                    <div class="col-lg-12">
                                ...
                                <div class="col-md-2">
                                    <label class="col-form-label col-lg-12"> المدرب <span class="text-danger">*</span>
                                    </label>
                                    <div class="col-lg-12">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <label class="col-form-label col-lg-12"> عنوان الكورس بالعربيه <span
                                            class="text-danger">*</span></label>
                                    <div class="col-lg-12">
                        ...
                        <div class="row mb-3">
                            <label class="col-form-label col-lg-12"> نبذه تعريفيه عن الكورس بالعربيه <span
                                    class="text-danger">*</span></label>
                            <div class="col-lg-12">
                        ...
                        <div class="row mb-3">
                            <label class="col-form-label col-lg-12"> نبذه تعريفيه عن الكورس بالانجليزيه <span
                                    class="text-danger">*</span></label>
                            <div class="col-lg-12">
                        ...
                        <div class="row mb-3">
                            <label class="col-form-label col-lg-12"> نظره عامه بالعربيه <span
                                    class="text-danger">*</span></label>
                            <div class="col-lg-12">
                        ...
                        <div class="row mb-3">
                            <label class="col-form-label col-lg-12"> نظره عامه بالانجليزيه <span
                                    class="text-danger">*</span></label>
                            <div class="col-lg-12">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="col-lg-12">
                                    <input type="date" name="discount_end_at" value='{{ old('discount_end_at') }}'
                        ...
                        <div class="row mb-3 ">
                            <div class="col-md-3">
                                <label class="col-form-label col-lg-12"> سعر الكورس فى حاله الدفعه المؤجله <span
                                        class="text-danger">*</span> </label>
                                <div class="col-lg-12">
                                    <input type="number" name="price_later" value='{{ old('price_later') }}'
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="row">
                                    <div class="col-lg-9">
                                    <input type="number" name="trainer_percentage" value='{{ old('trainer_percentage') }}'
