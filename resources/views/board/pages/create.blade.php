...
@section('page_title' , ' إضافه صفحه جديده' )

@section('breadcrumbs')
<a href="{{ route('board.pages.index') }}" class="breadcrumb-item"> صفحات الموقع </a>
<span class="breadcrumb-item active"> إضافه صفحه جديده </span>
@endsection
	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header bg-primary text-white">
				<h5 class="mb-0"> إضافه صفحه جديده </h5>
			</div>

			<form  method="POST" action="{{ route('board.pages.store') }}" enctype="multipart/form-data" >
				<div class="card-body">
					@csrf
					<div class="mb-4">
						...
						<div class="row mb-3">
							...
							<div class="col-lg-10">
								<input type="text" name="title_ar" value="{{ old('title_ar') }}" class="form-control @error('title_ar')  is-invalid @enderror" required placeholder="عنوان الصفحه بالعربيه">
								@error('title_ar')
						...
						<div class="row mb-3">
							...
							<div class="col-lg-10">
								<input type="text" name="title_en" value="{{ old('title_en') }}" class="form-control @error('title_en')  is-invalid @enderror" required placeholder="عنوان الصفحه بالانجليزيه">
								@error('title_en')
								<p class='text-danger' > {{ $message }} </p>
								@enderror
							</div>
