...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <a href="{{ route('board.countries.index') }}" class="btn btn-primary mb-2" style="float: left;">
                عرض كافه الدول <i class="icon-arrow-left7"></i></a>
        </div>
        <div class="col-md-12">
            <div class="card">
                    ...
                    <table class='table table-responsive  '>
                        <tbody>
                            <tr class='row'>
                                ...
                                <td class='col-md-10'> {{ $country->created_at }} <span class='text-muted'>
                                        {{ $country->created_at->diffForHumans() }} </span> </td>
                            </tr>

                            <tr class='row'>
                                <th class='col-md-2'> تم الاضافه بواستطه </th>
                                <td class='col-md-10'> <a href="{{ route('board.admins.show', $country->user_id) }}">
                                        {{ $country->user?->name }} </a> </td>
                            </tr>
