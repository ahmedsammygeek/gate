<div class="row">
    <div class="col-md-12">
     @can('packages.add')
     <a href="{{ route('board.packages.create') }}" class="btn btn-primary mb-2" style="float: left;">  <i class="icon-plus3  me-2"></i>  إضافه باقه جديده </a>
     @endcan
 </div>
                    ...
                    <tr>
                        ...
                        <td class="text-wrap">
                            ...
                            <td>
                                ...
                                <a href="{{ route('board.categories.show' , $package->category_id ) }}"> {{ $package->category?->name }} </a>
                                @endif
                            </td>
                            <td>
                            ...
                            <td> {{ $package->getPrice() }} <span class='text-muted' >  ر.س </span>  </td>
                            <td>
                            ...
                            <td class="text-center">
                                ...
                                @endcan
                                @can('packages.edit')
                                <a href="{{ route('board.packages.edit'  , $package ) }}"  class="btn btn-sm btn-warning ">
