    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header bg-primary">
                <h5 class="mb-0 text-white"> تقرير مستحقات الناشرين </h5>
            </div>
                ...
                <table class="table text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> {{ $course->course_purchases_total_amount  }} <span class='text-muted'> ريال </span> </td>
                            <td> {{ $course->total_course_purchases_transactions_amount  }} <span class='text-muted'> ريال </span> </td>
                            <td> {{ $course->course_purchases_total_amount - $course->total_course_purchases_transactions_amount  }} <span class='text-muted'> ريال </span> </td>

                            <td> {{ $course->trainer_percentage  }} % </td>
                            <td> {{ $course->trainer_total_amount_received_till_now  }} <span class='text-muted'> ريال </span> </td>
                            <td> {{ $course->trainer_total_dues  }} <span class='text-muted'> ريال </span> </td>
